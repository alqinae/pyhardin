...
- **Auto-Remediation Commands**: Doesn't just find problems. Hardin generates exact, safe, copy-pasteable terminal commands (`sed`, etc.) to instantly fix all discovered vulnerabilities.
...
| Command | Description |
|---|---|
| `hardin` | Runs the standard scan. Resumes automatically if interrupted. |
