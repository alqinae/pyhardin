...
def _prompt_api_key() -> str:
    ...
    if choice == 1:
        ...
        console.print("  [1] [cyan]gemini-2.5-flash[/cyan] (Default, very fast)")
        console.print("  [2] [white]gemini-2.5-pro[/white] (Highest intelligence)")
        console.print("  [3] [green]gemini-2.0-flash-thinking-exp[/green] (Advanced reasoning)")

        model_choice = IntPrompt.ask("\n[bold]Enter model number[/bold]", choices=["1", "2", "3"], default=1)
        mod_map = {1: "gemini-2.5-flash", 2: "gemini-2.5-pro", 3: "gemini-2.0-flash-thinking-exp"}
        ...
        console.print("  [1] [cyan]gpt-4o[/cyan] (Default)")
        console.print("  [2] [white]gpt-4o-mini[/white] (Faster, cheaper)")
        console.print("  [3] [green]o3-mini[/green] (Advanced reasoning)")

        model_choice = IntPrompt.ask("\n[bold]Enter model number[/bold]", choices=["1", "2", "3"], default=1)
        mod_map = {1: "gpt-4o", 2: "gpt-4o-mini", 3: "o3-mini"}
...
def main() -> None:
    ...
    parser.add_argument(
        "--reset",
        action="store_true",
        help="Wipe all API keys, model configurations, and tracking state, then restart the setup wizard",
    )
    parser.add_argument(
        "--set-key",
        metavar="KEY",
    ...
    try:
        ...
        if updated and not (args.list or args.scan is not None or args.no_resume or args.apply):
            return
