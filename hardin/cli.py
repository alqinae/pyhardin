...
def main() -> None:
    ...
    parser.add_argument(
        "--gui",
        action="store_true",
        help="Start the Hardin web dashboard",
    )
    parser.add_argument(
        "--host",
        default="0.0.0.0",
    ...
    try:
        ...
        if args.gui:
            ...
            os.environ["HARDIN_WEB_USER"] = web_user
            os.environ["HARDIN_WEB_PASS"] = web_pass
            ...
            uvicorn.run("hardin.web:app", host=host_bind, port=args.port)
            return
